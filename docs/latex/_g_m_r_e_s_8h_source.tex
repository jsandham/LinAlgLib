\doxysection{GMRES.\+h}
\hypertarget{_g_m_r_e_s_8h_source}{}\label{_g_m_r_e_s_8h_source}\index{C:/Users/jsand/Documents/LinAlgLib/library/include/LinearSolvers/GMRES.h@{C:/Users/jsand/Documents/LinAlgLib/library/include/LinearSolvers/GMRES.h}}
\mbox{\hyperlink{_g_m_r_e_s_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00026\ }
\DoxyCodeLine{00027\ \textcolor{preprocessor}{\#ifndef\ GMRES\_H}}
\DoxyCodeLine{00028\ \textcolor{preprocessor}{\#define\ GMRES\_H}}
\DoxyCodeLine{00029\ }
\DoxyCodeLine{00070\ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{_g_m_r_e_s_8h_a00813dbcba66da02438a1e1011fbdc79}{gmres}}(\textcolor{keyword}{const}\ \textcolor{keywordtype}{int}*\ csr\_row\_ptr,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{int}*\ csr\_col\_ind,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{double}*\ csr\_val,\ \textcolor{keywordtype}{double}*\ x,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{double}*\ b,}
\DoxyCodeLine{00071\ \ \ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{int}\ n,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{int}\ restart,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{double}\ tol,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{int}\ max\_iter);}
\DoxyCodeLine{00072\ }
