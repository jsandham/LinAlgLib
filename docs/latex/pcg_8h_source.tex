\doxysection{pcg.\+h}
\hypertarget{pcg_8h_source}{}\label{pcg_8h_source}\index{C:/Users/James/Documents/LinAlgLib/library/include/LinearSolvers/pcg.h@{C:/Users/James/Documents/LinAlgLib/library/include/LinearSolvers/pcg.h}}
...
\DoxyCodeLine{00005\ \textcolor{comment}{//\ Copyright(c)\ 2019-\/2024\ James\ Sandham}}
...
\DoxyCodeLine{00096\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{int}\ n,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{double}\ tol,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{int}\ max\_iter);}
\DoxyCodeLine{00097\ }
\DoxyCodeLine{00098\ \textcolor{keywordtype}{int}\ pcg2(\textcolor{keyword}{const}\ \textcolor{keywordtype}{int}*csr\_row\_ptr,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{int}*csr\_col\_ind,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{double}*\ csr\_val,\ \textcolor{keywordtype}{double}*\ x,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{double}*\ b,\ }
\DoxyCodeLine{00099\ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{int}\ n,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{double}\ tol,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{int}\ max\_iter);}
\DoxyCodeLine{00100\ }
