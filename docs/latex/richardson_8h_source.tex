\doxysection{richardson.\+h}
\hypertarget{richardson_8h_source}{}\label{richardson_8h_source}\index{C:/Users/jsand/Documents/LinAlgLib/library/include/LinearSolvers/richardson.h@{C:/Users/jsand/Documents/LinAlgLib/library/include/LinearSolvers/richardson.h}}
\mbox{\hyperlink{richardson_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00026\ }
\DoxyCodeLine{00027\ \textcolor{preprocessor}{\#ifndef\ RICHARDSON\_H}}
\DoxyCodeLine{00028\ \textcolor{preprocessor}{\#define\ RICHARDSON\_H}}
\DoxyCodeLine{00029\ }
\DoxyCodeLine{00068\ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{richardson_8h_a7674f38849a4880ccd336c6c691febb7}{rich}}(\textcolor{keyword}{const}\ \textcolor{keywordtype}{int}*\ csr\_row\_ptr,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{int}*\ csr\_col\_ind,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{double}*\ csr\_val,\ \textcolor{keywordtype}{double}*\ x,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{double}*\ b,\ }
\DoxyCodeLine{00069\ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{int}\ n,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{double}\ theta,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{double}\ tol,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{int}\ max\_iter);}
\DoxyCodeLine{00070\ }
