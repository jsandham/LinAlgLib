...
bool load_spd_mtx_file(const std::string& filename, 
					   std::vector<int>& csr_row_ptr, 
					   std::vector<int>& csr_col_ind, 
					   std::vector<double>& csr_val,
					   int& m,
					   ...
					   int& nnz)
{
	...
	load_mtx_file(filename, 
				  nontransposed.csr_row_ptr, 
				  nontransposed.csr_col_ind, 
				  nontransposed.csr_val, 
				  nontransposed.m, 
				  nontransposed.n, 
				  nontransposed.nnz);
	...
	csrgemm_nnz(nontransposed.m,
				...
				0, 
				1.0,
				nontransposed.csr_row_ptr.data(),
				nontransposed.csr_col_ind.data(),
				transposed.csr_row_ptr.data(),
				transposed.csr_col_ind.data(),
				0, 
				nullptr, 
				nullptr, 
				csr_row_ptr.data(), 
	...
	csrgemm(nontransposed.m,
			...
			nontransposed.csr_row_ptr.data(), 
			nontransposed.csr_col_ind.data(), 
			nontransposed.csr_val.data(),
			transposed.csr_row_ptr.data(), 
			transposed.csr_col_ind.data(), 
			transposed.csr_val.data(), 
			0,
			nullptr, 
			nullptr, 
			nullptr, 
...
bool check_solution(const std::vector<int>& csr_row_ptr, 
